...
//     {mainAtmosphere: "CH4"}
// )
// .projection({_id: 0, , name: 1, mainAtmosphere: 1})
...
// )
// .projection({_id: 0, name: 1, surfaceTemperatureC: 1})
...
//     {orderFromSun: {$gte: 5}}
// )
// .projection({_id: 0, name: 1, orderFromSun: 1}).sort({orderFromSun: 1}) // ASC
...
// )
// .projection({_id: 0, name: 1, hasRings: 1, orderFromSun: 1, "surfaceTemperatureC.mean": 1}).sort({orderFromSun: 1}) // ASC